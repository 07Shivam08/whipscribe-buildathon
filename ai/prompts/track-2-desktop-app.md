...
MCP server (https://whipscribe.com/claude). The reference for the level of
finish is Buzz (https://github.com/chidiwilliams/buzz).
...
1. Scaffold `apps/<my-name>/` with a README that will say how to run it and
