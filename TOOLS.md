...
|---|---|---|
| **WhipScribe MCP** — `https://whipscribe.com/mcp` | Your assistant can transcribe, list your library, search and manage folders on your own account. Sign in when the tool asks; setup notes at [whipscribe.com/claude](https://whipscribe.com/claude). | 2, 3 |
...
| **Context7** — `@upstash/context7-mcp` | Current docs for the library you are using (Tauri, Electron, Google APIs, your web framework) instead of the model's memory. | 2, 3 |
